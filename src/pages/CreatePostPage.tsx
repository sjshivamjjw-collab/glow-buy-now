...
const CATEGORIES: {
  ...
  { key: 'everyday_vibes', title: 'Daily Life', subtitle: 'Moments, moods, routines and little things from life', icon: Sparkles, accent: 'from-pink-500/20 to-orange-400/20 text-pink-500' },
