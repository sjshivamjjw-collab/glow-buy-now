  ...
  return (
    <div className="min-h-screen max-w-lg mx-auto pb-32 font-[Figtree] bg-[linear-gradient(180deg,#0a0a0a_0%,#111111_40%,#000000_100%)]">
      ...
      {isAnon ? (
        <div className="flex items-center gap-3 w-full px-4 py-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-[#a0a0a0]">Anonymous</p>
            {post.music_url && (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            {author?.username && <p className="text-xs text-[#a0a0a0]">@{author.username}</p>}
            {post.music_url && (
      ...
      {(post.title || post.body || post.location || post.hashtags.length > 0) && (
        <div className="bg-[#EAE4D8] px-5 pt-6 pb-7 mt-3">
          {post.title && (
